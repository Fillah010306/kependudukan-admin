...
<head>
    ...
    <title>Edit Data Penduduk - Neo System</title>
...
<body>
    ...
    <div class="form-container">
        <div class="form-header">
            ...
            <h1 class="form-title">Edit Data Penduduk</h1>
            <p class="form-subtitle">Perbarui informasi data penduduk yang sudah ada</p>
            
            <!-- User Info Badge -->
            <div class="user-info-badge">
                <i class="fas fa-id-card"></i>
                ID: {{ $penduduk->id }} | {{ $penduduk->first_name }} {{ $penduduk->last_name }}
            </div>
        </div>
        ...
        <div class="form-body">
            ...
            <form action="{{ route('penduduk.update', $penduduk->id) }}" method="POST" id="pendudukForm">
                @csrf
                @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="first_name" name="first_name" 
                                           value="{{ $penduduk->first_name }}" required 
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="last_name" name="last_name" 
                                           value="{{ $penduduk->last_name }}" required 
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="date" class="form-control" id="birthday" name="birthday" 
                                           value="{{ $penduduk->birthday }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="gender" name="gender" required>
                                    <option value="L" {{ $penduduk->gender == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="P" {{ $penduduk->gender == 'P' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                            </div>
                        </div>
                    </div>
